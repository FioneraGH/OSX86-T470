 ...
 *
 * Disassembly of SSDT-1-SaSsdt.aml, Sat Mar 17 09:47:21 2018
 *
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0x5B55F418, 0x01F7)
                ...
                While (One)
                {
                    ...
                    ElseIf ((_T_0 == 0x0D))
                    {
                        If ((Arg1 == One))
                        {
                            ...
                            Local0 = ((DerefOf (Arg3 [0x03]) << 0x18) | (DerefOf (Arg3 [0x02]) << 0x10))
                            Local0 &= 0xEFFF0000
                    ...
                    ElseIf ((_T_0 == 0x0F))
                    {
                        If ((Arg1 == One))
                        {
                            ...
                            Local0 |= 0x1800
                            Local0 |= (IDMS << 0x11)
                            Local0 |= (DerefOf (DerefOf (CDCT [HVCO]) [CDVL]) << 0x15)
                            Return (Local0)
                        }
                    }
                    ElseIf ((_T_0 == 0x10))
