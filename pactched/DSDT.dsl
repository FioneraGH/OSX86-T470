...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "SKL     ", 0x00000000)
{
    ...
    Name (SS3, 0x01)
    Name (SS4, 0x01)
    OperationRegion (GNVS, SystemMemory, 0x5B54E000, 0x072C)
        ...
        Device (XHC)
        {
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                ...
                If ((Arg0 == ToUUID ("ac340cb7-e901-45bf-b7e6-2b34ec931e23")))
                {
                    ...
                    {
                        ADBG ("SSIC")
                        If ((((PCCS == 0x00) || (PTPP == 0x00)) || ((PPLS >= 0x04) && (PPLS <= 0x0F))))
                        {
                            If ((PPLS == 0x08))
                            {
                                D3HE = One
            ...
            Method (_PS3, 0, Serialized)  // _PS3: Power State 3
            {
                ...
                If ((UWAB && ((D0D3 == 0x03) && ((\_SB.PCI0.XDCI.D0I3 == 0x03) || (\_SB.PCI0.XDCI.DVID == 0xFFFF)))))
                {
                    MPMC = 0x03
                    While (PMFS)
                    {
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Device (SAT0)
        {
            ...
            Method (PSTA, 1, Serialized)
            {
                ...
                {
                    If ((\_SB.PCI0.GEXP.GEPS (DerefOf (Arg0 [0x01]), DerefOf (Arg0 [0x02])) == DerefOf (Arg0 [0x03])))
                    {
                        Return (0x01)
                    }
            ...
            Method (PON, 1, Serialized)
            {
                If ((DerefOf (Arg0 [0x00]) != 0x00))
                {
                    ...
                    If ((DerefOf (Arg0 [0x00]) == 0x02))
                    {
                        ...
                        \_SB.PCI0.GEXP.SGEP (DerefOf (Arg0 [0x01]), DerefOf (Arg0 [0x02]), DerefOf (Arg0 [0x03]))
                    }
                }
            }
            ...
            Method (POFF, 1, Serialized)
            {
                If ((DerefOf (Arg0 [0x00]) != 0x00))
                {
                    ...
                    If ((DerefOf (Arg0 [0x00]) == 0x02))
                    {
                        ...
                        \_SB.PCI0.GEXP.SGEP (DerefOf (Arg0 [0x01]), DerefOf (Arg0 [0x02]), (DerefOf (Arg0 [0x03]) ^ 0x01))
                    }
                }
            }
        }
        ...
        Device (EC)
        {
            ...
            Method (GBST, 4, NotSerialized)
            {
                ...
                Else
                {
                    ...
                    If ((((Local0 & 0x04) == 0x00) && ((Local2 > 0x00) && (Local3 > 0x00))))
                    {
                        BSWA &= ~Local5
                        Arg3 [0x00] = Local0
                        Arg3 [0x01] = Local1
    ...
    Method (OPTS, 1, NotSerialized)
    {
        ...
        If (Local0)
        {
            ...
            If ((Arg0 != 0x05))
            {
                \_SB.PCI0.RP09.PDSF = \_SB.PCI0.RP09.PDSX
            }
    ...
    Method (OWAK, 1, NotSerialized)
    {
        ...
        If ((\_SB.PCI0.RP09.PDSX ^ \_SB.PCI0.RP09.PDSF))
        {
            \_SB.PCI0.RP09.PDSF = \_SB.PCI0.RP09.PDSX
    ...
    Scope (\_SB)
    {
        ...
        Method (WRGP, 2, Serialized)
        {
            ...
            {
                \_SB.CGWR ((Local0 & 0xFF), (Local1 >> 0x18), ((Local1 << 0x08) >> 0x18), Arg1)
            }
        }
        ...
        Method (RDGP, 2, Serialized)
        {
            ...
            If (((Local0 & 0xFF) == 0x01))
            {
                Local7 = \_SB.CGRD ((Local0 & 0xFF), (Local1 >> 0x18), Local1, Arg1)
            }
            ElseIf (((Local0 & 0xFF) == 0x02))
            {
                Local7 = \_SB.CGRD ((Local0 & 0xFF), (Local1 >> 0x18), ((Local1 << 0x08) >> 0x18), Arg1)
            }
    ...
    Device (PSM)
    {
        ...
        Method (DPLC, 0, Serialized)
        {
            ...
            DerefOf (DerefOf (DPLX [0x01]) [0x02]) [0x00] = \DLI1
            DerefOf (DerefOf (DPLX [0x01]) [0x02]) [0x01] = \DPL1
            DerefOf (DerefOf (DPLX [0x01]) [0x02]) [0x02] = \DTW1
            DerefOf (DerefOf (DPLX [0x01]) [0x02]) [0x03] = \DMI1
            DerefOf (DerefOf (DPLX [0x01]) [0x02]) [0x04] = \DMA1
            DerefOf (DerefOf (DPLX [0x01]) [0x02]) [0x05] = \DMT1
            DerefOf (DPLX [0x02]) [0x00] = \DDT2
            DerefOf (DPLX [0x02]) [0x01] = \DDP2
            DerefOf (DerefOf (DPLX [0x02]) [0x02]) [0x00] = \DLI2
            DerefOf (DerefOf (DPLX [0x02]) [0x02]) [0x01] = \DPL2
    ...
    OperationRegion (MNVS, SystemMemory, 0x5B560018, 0x1000)
    ...
    {
        SMI (0x18, (Arg0 & 0xFF), (Arg1 & 0xFF), (Arg2 & 0xFF), 0x00)
    }
    ...
    Scope (\_SB.PCI0.LPCB.EC)
    {
        ...
        Method (_Q2B, 0, NotSerialized)  // _Qxx: EC Query
        {
            ...
            \VCMS (0x01, \_SB.LID._LID ())
            If ((\_SB.PCI0.LPCB.EC.AC._PSR () == 0x00))
            {
                ADBG ("LIDC0")
